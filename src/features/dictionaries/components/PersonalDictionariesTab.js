...
export default function Personal() {
    ...
    return (
        <View style={{ flex: 1, paddingHorizontal: 15, backgroundColor: colors.common.background }}>
            <Text style={{ fontWeight: '700', fontSize: 20, marginVertical: 10, color: dColors.title }}>{t('personalDictionaries')}</Text>
            {dictReload
            ...
            <TouchableOpacity style={[styles.addDictButton, { backgroundColor: dColors.addBtnBg }]} onPress={() => setVisible(true)}>
                <MaterialCommunityIcons style={{ fontWeight: '900' }} name="book-plus-outline" size={24} color={dColors.addBtnIcon} />
            </TouchableOpacity>
